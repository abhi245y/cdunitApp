...
class Ui_AddBundleDetails(object):
    ...
    def showMessage(self, msgType, data):
        msgBox = QMessageBox()
        ...
        for row in range(rowCount):
            ...
            for column in range(columnCount):
                ...
                if widgetItem and widgetItem.text:
                    ...
                    rowData.append('NULL')
            finalData.append({"qpSeries": rowData[0], "qpCode": rowData[1],
                              "receivedDate": datetime.strptime(rowData[2], '%a %b %d %Y'), "messenger": rowData[3],
    ...
    def sortCollegeListBasedOnRoute(self):
        ...
        with open(r"data\route_list.json", "r") as read_file:
            ...
            for routes in route_list:
                if routes["Route"] == self.cbRouteList.currentText():
                    self.cbCollegeList.addItem(routes["College Name"] + " " + routes["Place"])
    ...
    def addDataToTable(self):
        ...
        self.twBundleDetails.setItem(rowPosition, 2, QtWidgets.QTableWidgetItem(slipDate))
        self.twBundleDetails.setItem(rowPosition, 3, QtWidgets.QTableWidgetItem(messengerName))
        self.twBundleDetails.setItem(rowPosition, 4, QtWidgets.QTableWidgetItem(clgName))
