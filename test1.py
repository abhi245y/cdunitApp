...
class Ui_AddBundleDetails(object):
    def setupUi(self, AddBundleDetails):
        ...
        AddBundleDetails.resize(791, 573)
    ...
    def retranslateUi(self, AddBundleDetails):
        ...
        self.ticBoxNillStatment.setText(_translate("AddBundleDetails", "Check If Bundle Is Nill"))
        ...
        self.btnDeleteSelectedRow.setText(_translate("AddBundleDetails", "Delete Selected Row"))
